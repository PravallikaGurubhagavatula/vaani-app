...
(function () {
  ...
  function _renderLogin() {
    ...
    root.innerHTML = '<div class="vg-screen vg-login-screen"><div class="vg-card">' +
      '<div class="vg-card-icon"><svg viewBox="0 0 24 24"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/><circle cx="7.5" cy="10" r="0.5"/><circle cx="12" cy="10" r="0.5"/><circle cx="16.5" cy="10" r="0.5"/></svg></div>' +
